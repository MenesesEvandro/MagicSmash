...
- **Session timer** — 3, 5, 10, or 15 minutes, or no limit, right on the welcome screen; 30, 45, and 60-minute options live behind the parent gate in Settings, for a longer stretch a curious toddler can't set for themselves. Ends in a friendly recap screen. Opening Settings or Stats mid-session pauses the clock, so checking on something doesn't eat into playtime.
